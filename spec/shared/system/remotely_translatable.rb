shared_examples "remotely_translatable" do |factory_name, path_name, path_arguments|
  ...
  context "Button to request remote translation" do
    ...
    describe "should ignore missing translations on resource comments", if: index_path?(path_name) && commentable?(factory_name) do
    ...
    describe "should evaluate missing translations on featured_proposals", if: path_name == "proposals_path" do
