...
RSpec.describe Poll::Question do
  ...
  describe "#find_or_initialize_user_answer" do
    ...
    context "unique question" do
      ...
      it "sets option and answer to nil when option_id is nil" do
        blank = question.find_or_initialize_user_answer(user, answer_text: "ignored")
    ...
    context "essay question" do
      ...
      it "raises when option_id is invalid (we call find before branching)" do
        expect do
          question.find_or_initialize_user_answer(user, option_id: 999999, answer_text: "Hi")
        end.to raise_error(ActiveRecord::RecordNotFound)
      end
