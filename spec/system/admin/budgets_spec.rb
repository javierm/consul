...
describe "Admin budgets", :admin do
  ...
  context "Index" do
    ...
    scenario "Displaying budget information", :js do
    ...
    scenario "Displaying budget current phase information for non common cases", :js do
      ...
      travel_to(Date.new(2015, 7, 15)) do
        ...
        within_table "Phases" do
          within "tr", text: "Information" do
            ...
            expect(page).to have_field "Enable Selecting projects phase"
          end
        end
      end
    end
