  ...
  context "question is essay" do
    ...
    it "renders essay headers and empty counts when there are no participants" do
      ...
      page.find("#question_#{essay_question.id}_results_table") do |table|
        ...
        expect(table).to have_css "th", text: "Blank"
    ...
    it "render counts for answered/unanswered among valid poll participants" do
      ...
      create(:poll_answer, question: essay_question, author: user_1, answer: "Open text A")
      create(:poll_answer, question: essay_question, author: user_2, answer: "Open text B")
      create(:poll_answer, question: essay_question, author: user_3, answer: "Open text C")
