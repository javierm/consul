class GlobalizeLocalesComponent < ApplicationComponent
  include TranslatableFormHelper
  include LocalesHelper
  include GlobalizeHelper
  include SiteCustomizationHelper
  ...
  def render?
    translations_interface_enabled? || translating_custom_infomation_texts?
  end

  private

    def translating_custom_infomation_texts?
      resource.nil?
    end
